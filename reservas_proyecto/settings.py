...
"""
Django settings for reservas_proyecto project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'reservas_salas_db',
        'USER': 'root',           
        'PASSWORD': '',  # Coloca tu contraseña de MySQL si tienes
        'HOST': 'localhost',      
        'PORT': '3306',          
        'OPTIONS': {
...
# CORS Settings (permitir todas las solicitudes en desarrollo)
